...
export const Signup = () => {
  ...
  const handlesubmit = async (e) => {
    ...
    const response = await fetch(
      `http://${state.backend}:${state.port}/api/auth/createuser`,
      {
        method: "POST",
        headers: {
              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-6" action="#">
                  <div>
                    <label
                      htmlFor="name"
                      className="block mb-2 text-sm font-medium text-gray-900 dark:text-white dlabel"
                    >
                      Full Name
                    </label>
                    <input
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={mobile_input}
                      onChange={(e) => {
                        setmobile_input(e.target.value);
                      }}
                      required
                      min={10}
                      max={10}
