...
export const Temp = () => {
  ...
  const submitfeedback = async (e) => {
    ...
    const response = await fetch(
      `http://${state.backend}:${state.port}/api/f/feedback`,
      {
        method: "POST",
        headers: {
      ...
      <div className="fmdiv">
        <div className="feedbackform">
          ...
          <form onSubmit={submitfeedback}>
            ...
            <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 feedsub">
              Submit
            </button>
          </form>
        </div>
