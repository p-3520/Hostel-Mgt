...
export const Complains = () => {
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div
        id="toast-success"
        className="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 absolute right-5 top-5 hidden opacity-0"
        role="alert"
      >
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              nulla nam molestiae asperiores omnis laudantium inventore odit,
              porro amet eveniet consequuntur dignissimos natus, unde iusto
              deleniti temporibus. Fuga, rerum quod?
            </div>
            <div className="modal-footer">
              <button className="focus:outline-none text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-4 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 m-2">
                Solved
              </button>
              <button className="focus:outline-none text-white bg-red-700 hover:bg-red-800 font-medium rounded-lg text-sm px-4 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 m-2">
                Delete
              </button>
            </div>
          </div>
            ...
            <div className="modal-body">
              <form onSubmit={handle}>
                ...
                <div className="modal-footer">
                  ...
                  <button
                    type="button"
                    className="btn btn-secondary grcolor font-medium rounded-lg text-sm sm:w-auto px-4 py-2.5"
                    data-bs-dismiss="modal"
                  >
                    Close
                  </button>
                  <button
                    type="submit"
                    className={`text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 extrablue`}
                  >
                    Submit
                  </button>
                </div>
