...
export const Adminhome = () => {
  ...
  const getalldata = async (e) => {
    const response = await fetch(
      `http://${state.backend}:${state.port}/api/ad/getallusers`,
      {
        method: "get",
        headers: {
      ...
      for (let i = 0; i < parseInt(json.data.length); i++) {
        ...
        bodykadata.push(
          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <td className="px-6 py-4">{sname}</td>
            <td className="px-6 py-4">something</td>
            <td className="px-6 py-4">else</td>
            <td className="px-6 py-4">Here</td>

            <td className="px-6 py-4 ">
              <button
                className="pview"
                onClick={() => (window.location = `mailto:${semail}`)}
              >
                View
              </button>
            </td>
              ...
              <div className="flex-auto p-4">
                <div className="flex flex-row -mx-3">
                  <div className="flex-none w-2/3 max-w-full px-3">
                    <div>
                      <p
                        className="mb-0 font-sans font-semibold leading-normal text-sm"
                        style={{ color: " #67748e", display: "flex" }}
                      >
                        Rooms
                      </p>
                      <h5 className="mb-0 font-bold hclass">
                        200
                        <span className="leading-normal text-sm font-weight-bolder text-lime-500 lef200">
                          left
                        </span>
                      </h5>
                    </div>
                  ...
                  <div className="px-3 text-right basis-1/3">
                    <div className="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500  bluegrad albasics">
                      <MeetingRoomRoundedIcon className="whitess meetrome" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
              <div className="flex-auto p-4">
                <div className="flex flex-row -mx-3">
                  ...
                  <div className="px-3 text-right basis-1/3">
                    <div className="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500 bluegrad albasics">
                      <BadgeRoundedIcon className="whitess meetrome" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-row -mx-3">
                  <div className="flex-none w-2/3 max-w-full px-3">
                    <div>
                      ...
                      <h5 className="mb-0 font-bold hclass">
                        6
                        <span className="leading-normal text-red-600 text-sm font-weight-bolder lef200">
                          Today
                        </span>
                      </h5>
                    </div>
                  ...
                  <div className="px-3 text-right basis-1/3 ">
                    <div className="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500 bluegrad albasics">
                      <QrCode2RoundedIcon className="whitess meetrome" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
              <div className="flex-auto p-4">
                <div className="flex flex-row -mx-3">
                  ...
                  <div className="px-3 text-right basis-1/3 ">
                    <div className="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500 bluegrad albasics">
                      <WarningRoundedIcon className="whitess meetrome" />
                    </div>
                  </div>
                </div>
              </div>
