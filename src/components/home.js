  ...
  const handle = async (e) => {
    ...
    const response = await fetch(
      `http://${state.backend}:${state.port}/api/b/bookroom`,
      {
        ...
        body: JSON.stringify({ room: roomno.sroom }),
      }
    );
                ...
                <div className="flex flex-wrap -mx-3 twrem">
                  <div className="max-w-full px-3 lg:w-1/2 lg:flex-none">
                    <div className="flex flex-col h-full">
                      ...
                      <h5 className="font-bold">USIU Hostelss</h5>
                      <p className="mb-12">
                      ...
                      <a
                        ...
                        target={"_blank"}
                        href="https://www.nitj.ac.in/index.php/nitj_cinfo/index/23"
                      >
                        Read More
                        <i
                ...
                <div className="relative z-10 flex flex-col flex-auto h-full p-4">
                  ...
                  <div>
                    <div className="d-flex rdetails">
                      ...
                      <p className="stdd">
                        Hostel : <span className="hstdd">MBHF</span>
                      </p>
                    </div>
                    <div className="d-flex rdetails">
                      <p className="stdd">
              ...
              <div className="flex-auto p-4">
                <div className="py-4 pr-1 mb-4 bg-gradient-to-tl rounded-xl ">
                  <div className="blackbgp">
                    <div className="smoky">
                      <div className="d1">
                        <img className="sm1 smdelay" src={smoke} alt="" />
                        <img className="sm1 sm2 smdelay" src={smoke} alt="" />
                        <img className="sm1 sm3 smdelay" src={smoke} alt="" />
                      </div>
                      <div className="d2">
                        <img className="sm1" src={smoke} alt="" />
                        <img className="sm1 sm2" src={smoke} alt="" />
                        <img className="sm1 sm3" src={smoke} alt="" />
                      </div>
                      <div className="d3">
                        <img className="sm1 smdelay2" src={smoke} alt="" />
                        <img className="sm1 sm2 smdelay2" src={smoke} alt="" />
                        <img className="sm1 sm3 smdelay2" src={smoke} alt="" />
                      </div>
                      <div className="d4">
                        <img className="sm1 zsm" src={smoke} alt="" />
                        <img className="sm1 sm2 zsm" src={smoke} alt="" />
                        <img className="sm1 sm3 zsm" src={smoke} alt="" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <ul className="thisisul" id="ulof">
                    <li className="text-whit twl">
                      Mess Refund will given combined at the end of this
                      semester
                    </li>
                    <li className="text-whit twl">
                      Attention Network Committee members, please be informed
                      that we have a meeting scheduled for today at 5 pm. Kindly
                      ensure that you arrive on time.
                    </li>
                    <li className="text-whit twl">
                      Students are requested to not to pluck flowers from
                      garden.Dear students, Let's appreciate the beauty of
                      nature without causing harm to it.
                    </li>
                    <li className="text-whit twl">
                      Attention all students! We're excited to announce the
                      upcoming sports meet that will be held on the athletic
                      grounds. More details will provided soon, Let's gear up
