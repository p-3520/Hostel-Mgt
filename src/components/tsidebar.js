...
export const Tsidebar = () => {
  ...
  const stopcvfunc2 = async (e) => {
    ...
    canvas
      .getContext("2d")
      .drawImage(videoEl, 0, 0, canvas.width, canvas.width);
    ...
    var jpegFile64 = image_data_url.replace(
    ...
    axios
      .post(`http://${state.backend}:${state.port}/api/a/newupload`, formData, {
        headers: {
  ...
  return (
    <>
      ...
      <div
        id="sideid"
        className={`kaguya relly max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent translate-x-0 shadow-soft-xl bckol ps2 ${
          state.value ? "flex" : "displaynone"
        }`}
      ...
      >
        <div className="h-19.5">
          ...
          >
            ...
            <span className="ml-1 font-semibold transition-all duration-200 ease-nav-brand">
              Hostel Dashboard
              <button onClick={Vmodalopen}></button>
            </span>
          </Link>
        </div>
        ...
        <div className="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full ps2 scrollcs ps--active-y">
          <ul id="udlist" className="flex flex-col pl-0 mb-0">
            <li className="mt-0.5 w-full">
              <Link
                className={`py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 font-semibold text-slate-700 transition-colors ${
                  isact === 1 && "shadow-soft-xl rounded-lg bg-white"
                }`}
                to="/home"
              >
                <div
                ...
                >
                  <HomeRoundedIcon
                    className={`${isact === 1 ? "whitess" : "blackss"}`}
                  />
                </div>
              ...
              >
                ...
                >
                  <CrisisAlertRoundedIcon
                    className={`${isact === 4 ? "whitess" : "blackss"}`}
                  />
                </div>
                <span className="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">
                  Complains
            ...
            <li className="mt-0.5 w-full" id="feedbackli">
              <Link
                onClick={() => setact(3)}
                className={`py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 font-semibold text-slate-700 transition-colors ${
                  isact === 3 && "shadow-soft-xl rounded-lg bg-white"
                }`}
                to="/temp"
              >
                <div
                ...
                >
                  <CalendarMonthIcon
                    className={`${isact === 3 ? "whitess" : "blackss"}`}
                  />
                </div>
                <span className="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">
                  Feedback
          ...
          <div
            ...
            style={{ fontWeight: "750", left: "0px", bottom: "0px" }}
          >
        ...
        <div className="mx-4">
          ...
          >
            ...
            ></div>
            <div
              className="relative z-20 flex-auto w-full p-4 text-left text-white ps2"
              style={{ overflow: "auto", maxHeight: "200px" }}
            >
              <div className="d-flex">
                <div className="vecdiv">
                  <img className="vec2" src={state.user_photo_url} alt="" />
                </div>
              ...
              <div className="mbody d-flex">
                    ...
                    <div className="profile-card-body">
                      <ul className="profile-card-details">
                        <li className="profile-card-details-item">
                          <span className="profile-card-details-label">
                            Hostel :
                          </span>
                          <span className="profile-card-details-value">
                            MBH F
                          </span>
                        </li>
                        <li className="profile-card-details-item">
                ...
                <div className="rightp">
                  ...
                  <div className="btnd mx-2">
                    <button
                      className="btn btn-secondary opencvbtn"
                      id="opencv2"
                      onClick={opencv2}
                    >
